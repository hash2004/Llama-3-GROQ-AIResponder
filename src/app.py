...
from personalized_chatting import initialize_api_connections, run_chat, initalize_context
from speech_to_text import speech_to_text
from st_audiorec import st_audiorec
from context import initialize_api_connections_context


# Initialize API connections
llm, astra_vector_index = initialize_api_connections()
context_llm = initialize_api_connections_context()
placeholder  = initalize_context("test")
...
if not llm or not astra_vector_index:
    ...
    if submit_button and user_input:
        if user_input.strip() == "quit":
            ...
            try:
                answer = run_chat(llm, astra_vector_index, user_input, context_llm)
